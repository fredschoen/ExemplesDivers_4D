...
If (Form event code:C388=On Drop:K2:12)
	...
	Case of 
		...
		: (Form:C1466.prescription2Dragged_o#Null:C1517)  //on vient de la liste 1
			...
			$posDrop:=Form:C1466.Ordonnance_e.Ordonnance_o.Prescription2_c[FORM Event:C1606.row-1].pos-0.1
			Form:C1466.Ordonnance_e.Ordonnance_o.Prescription2_c[Form:C1466.prescription2PosCurElt-1].pos:=$posDrop
	...
	// tri
	Form:C1466.Ordonnance_e.Ordonnance_o.Prescription2_c:=Form:C1466.Ordonnance_e.Ordonnance_o.Prescription2_c.orderBy("pos")
